  ...
  return (
    <>
      ...
      <Section className='overflow-y-hidden'>
        ...
        <GrayDivider />
<div className="grid grid-cols-4 gap-8 w-full py-16">
  <div className="flex flex-col items-start">
    <TickText text={140} className="text-7xl font-bold text-black" />
  ...
  <div className="flex flex-col items-start">
    <TickText text={7500} suffix="+" className="text-7xl font-bold text-black text-align text-center" />
    <p className="text-xl text-black">
