        ...
        <Section>
          <div className="text-lg font-sans" style={{ paddingTop: "200px" }}>
            ...
            <Text className="pb-10">
              ...
              a time-consuming and complicated process. In their project, fellows
              would produce a policy brief identifying opportunities and outlining a 
              realistic strategy for AI integration in different phases of the permitting process, from
