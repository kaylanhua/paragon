...
export default function HeroSection() {
    ...
    return <section className="relative flex w-full md:py-10 py-10 h-[100vh] justify-center items-center">
        <div className={`md:w-[1350px] w-screen max-w-[85vw] mx-10 hero-text-fadein`}>
            ...
            <div className="animate-bounce absolute bottom-[10vh] left-0 z-10 w-full flex justify-center text-4xl"><RiArrowDownLine /></div>
